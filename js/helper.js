...
let textExercise = "В центральному блоці («3» або «4») однієї із ваших сторінок за допомогою JS (та при потребі CSS) автоматизуйте процес створення об’єкта (або набору об’єктів) згідно із варіантом завдання із довільним контентом. Кількість елементів, порядок розташування елементів і контент в елементах задає користувач сторінки.";